...
public class UserFeedbackActivityOne extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG,"in user feedback one"); //added luis
        ...
        submitButton.setOnClickListener(v -> {
            ...
            //String severity=typeSpinner.getSelectedItem().toString();
            ...
            int credibility = rating2==1?-2:rating2==2?-1:rating2==3?0:rating2==4?1:2;
