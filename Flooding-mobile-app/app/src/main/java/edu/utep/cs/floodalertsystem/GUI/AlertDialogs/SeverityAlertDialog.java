...
/**
 * <h1> Severity Alert Dialog</h1>
 *
 * This class sets the layout for the Severity Alert Dialog
 *
 *
...
public class SeverityAlertDialog extends DialogFragment {
    private final String TAG="Flood";
    private final String ACTIVITY="SeverityAlertDialog: ";

    public static SeverityAlertDialog newInstance(int title) {
        SeverityAlertDialog frag = new SeverityAlertDialog();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setView(inflater.inflate(R.layout.dialog_alert_severity, null))
